@extends('panel.layout.master' , ['title' => 'المديرين'])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">المديرين</h3>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('panel.admins.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
@push('js')
    ...
    <script>
        ...
        window.data_url = '{{url('panel/admins/datatable')}}';
        ...
        window.columns = [
            ...
            },
            {
                ...
                width: 100,
                template: function (data) {
                    var editUrl = "{{ url('panel/admins/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/admins/') }}/" + data.id;
                    return `
